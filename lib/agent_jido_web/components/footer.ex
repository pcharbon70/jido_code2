defmodule AgentJidoWeb.Components.Footer do
  @moduledoc """
  The `AgentJidoWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,

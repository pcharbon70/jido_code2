defmodule AgentJidoWeb.Components.Overlay do
  @moduledoc """
  The `AgentJidoWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `AgentJidoWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,

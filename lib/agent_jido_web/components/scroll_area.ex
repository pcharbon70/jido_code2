defmodule AgentJidoWeb.Components.ScrollArea do
  @moduledoc """
  The `AgentJidoWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView

defmodule AgentJidoWeb.Components.Menu do
  @moduledoc """
  The `AgentJidoWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `AgentJidoWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import AgentJidoWeb.Components.Button, only: [button_link: 1]

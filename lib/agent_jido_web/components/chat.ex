defmodule AgentJidoWeb.Components.Chat do
  @moduledoc """
  `AgentJidoWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.

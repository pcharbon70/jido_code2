defmodule AgentJidoWeb.Components.CheckboxCard do
  @moduledoc """
  The `AgentJidoWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView

defmodule AgentJidoWeb.Components.Clipboard do
  @moduledoc """
  The `AgentJidoWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.

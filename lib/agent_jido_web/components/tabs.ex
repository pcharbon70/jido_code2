defmodule AgentJidoWeb.Components.Tabs do
  @moduledoc """
  `AgentJidoWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import AgentJidoWeb.Components.Badge, only: [badge: 1]

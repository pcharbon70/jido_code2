defmodule AgentJidoWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {AgentJidoWeb.Layouts, :root}
  ...
  scope "/api/json" do
    ...
    forward "/", AgentJidoWeb.AshJsonApiRouter
  end
  ...
  scope "/", AgentJidoWeb do
    ...
    confirm_route AgentJido.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [AgentJidoWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(AgentJido.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [AgentJidoWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]
    )
  end

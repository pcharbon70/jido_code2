defmodule JidoCodeWeb.Components.Stepper do
  @moduledoc """
  The `JidoCodeWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `JidoCodeWeb.Components.Stepper` enhances user experience by providing a clear and concise representation

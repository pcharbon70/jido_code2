defmodule JidoCode.WorkflowRuntime.StepHandlers.CommitAndPR do
  ...
  defp commit_message_block_reason(errors) when is_list(errors) do
    cond do
      Enum.any?(errors, fn error ->
        map_get(error, :reason, "reason") in ["workflow_metadata_mismatch", "run_id_metadata_mismatch"]
      end) ->
  ...
  defp commit_message_detail(_status, _errors), do: "Commit message failed required contract validation."
  ...
  defp commit_summary_from_args(args, workflow_name) when is_map(args) do
    ...
    |> map_get(
      ...
      map_get(
        ...
        :summary,
        "summary",
        map_get(args, :task_summary, "task_summary", map_get(args, :change_summary, "change_summary"))
      )
    )
